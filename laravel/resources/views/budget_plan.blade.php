...
$photo = DB::table('photos')->where('id','=',$services[0]['attributes']['photo_id'])->first();
?>
            ...
            <div class="row reset-gutter">
                <div class="col-md-6">
                    <div class="service-item-content ">
                        <h2>
                            <span>{{$services[0]['attributes']['main_title'.$Language]}}</span> Plan
                        </h2>
                        ...
                        <div class="row">
                            <div class="col-md-6 service-feature-item">
                                <p><i class="fa fa-check"></i>
                                      {{$services[0]['attributes']['title1'.$Language]}}</p>
                            </div>
                            <div class="col-md-6 service-feature-item">
                                <p><i class="fa fa-check"></i>
                                      {{$services[0]['attributes']['title2'.$Language]}}</p>
                            </div>
                            <div class="col-md-6 service-feature-item">
                                <p><i class="fa fa-check"></i>
                                      {{$services[0]['attributes']['title3'.$Language]}}</p>
                            </div>
                            <div class="col-md-6 service-feature-item">
                                <p><i class="fa fa-check"></i>
                                      {{$services[0]['attributes']['title4'.$Language]}}</p>
                            </div>
                            <div class="col-md-6 service-feature-item">
                                <p><i class="fa fa-check"></i>
                                      {{$services[0]['attributes']['title5'.$Language]}}</p>
                            </div>
                            <div class="col-md-6 service-feature-item">
                                <p><i class="fa fa-check"></i>
                                      {{$services[0]['attributes']['title6'.$Language]}}</p>
                            </div>
                        </div>
                        ...
                        <div class="price">
                            <p>
                                starting form
                                <span>
                                                {{$services[0]['attributes']['price']}}<em>
                                                    /month
                                                </em>
                                            </span>
                            </p>
        ...
        <div class="container">
            <div class="row reset-margin">
                <div class="col-md-3 col-sm-6 pricing-table-item mt-md">
                    <div class="pt-body">
                        <div class="pt-features pt2-left-header">
                            <ul class="text-left">
                                <li>{{$services[0]['attributes']['title1'.$Language]}}</li>
                                <li>{{$services[0]['attributes']['title2'.$Language]}}</li>
                                <li>{{$services[0]['attributes']['title3'.$Language]}}</li>
                                <li>{{$services[0]['attributes']['title4'.$Language]}}</li>
                                <li>{{$services[0]['attributes']['title5'.$Language]}}</li>
                                <li>{{$services[0]['attributes']['title6'.$Language]}}</li>
                ...
                <div class="col-md-3 col-sm-6 pricing-table-item">
                    <div class="pt-body">
                        <div class="pt-plan text-center">{{$services[0]['attributes']['main_title']}}</div>
